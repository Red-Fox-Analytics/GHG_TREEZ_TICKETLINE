...
SELECT ic.PRODUCTBRAND, ic.PRODUCTNAME, ic.PRODUCTTYPE,tsub.PRODUCTSUBTYPE,tsub."SIZE", tsub.UNITOFMEASURE,  cast(ic.STOREID as varchar) STOREID, ic.START_DATE,
		...
		, (sum(UNIT_SALES_TICKETLINE_RF) over(PARTITION BY ic.STOREID, ic.PRODUCTNAME
											ORDER BY ic.STOREID, ic.PRODUCTNAME,ic.START_DATE desc ROWS  between 28 preceding and current ROW))/4 AVG_WEEKLY_UNIT_SALES_ROLLING_4W_RF
